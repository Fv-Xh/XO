...
public class GameResolver {
    ...
    public static GameState calculateGameState(int[][] board, Board.Cell position){ //You start playing and count the cases

        int gamePiece = board[position.row][position.col];
        if (gamePiece == 0) return GameState.IN_PROGRESS;  //Call in progress
        // DOWN DIRECTION
    ...
    public static GameState resolve(int[][] board) { //Learn that the game is over or No
