...
public class Board {
    ...
    public void instructionBoard(){          // Print the main board
        System.out.println("| - | - | - |");
    ...
    public void displayBoard(){             //Cases
        System.out.println("| - | - | - |");
    ...
    public boolean placePieceRandomly(String pieceType){   //Bot
    ...
    public boolean isFull(){    //Extracts the winner
    ...
    private String printBoardRow(int row){           
        ...
        for(int i=0;i<board[0].length;i++){
            if(board[row][i] == 0) rowBuilder.append(" ");// Print Vacuum
            if(board[row][i] == 1) rowBuilder.append("X");// Print x
            if(board[row][i] == 2) rowBuilder.append("O");// Print o
            rowBuilder.append(" | ");
        }
